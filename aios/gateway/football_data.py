...
_TEAM_PROFILES = {
    ...
    "日本": {"fifa_rank": 18, "style": "技术流、团队配合", "stars": "久保建英、三笘薰", "recent": "亚洲杯表现稳定"},
    "韩国": {"fifa_rank": 22, "style": "体能+纪律、永不放弃", "stars": "孙兴慜", "recent": "亚洲传统强队"},
    "加拿大": {"fifa_rank": 43, "style": "身体对抗、快速推进", "stars": "戴维斯", "recent": "联合东道主，历史性参赛"},
    # 欧冠/欧联球队
    "巴黎圣日耳曼": {"fifa_rank": "N/A", "style": "豪华阵容、控球进攻", "stars": "登贝莱、巴尔科拉、阿什拉夫", "recent": "法甲领头羊，欧冠四强常客"},
    "利物浦": {"fifa_rank": "N/A", "style": "高位逼抢、快速反击", "stars": "萨拉赫、范戴克、麦卡利斯特", "recent": "英超争冠，欧冠经验丰富"},
    "巴塞罗那": {"fifa_rank": "N/A", "style": "传控足球、青训造血", "stars": "亚马尔、莱万、佩德里", "recent": "西甲领跑，年轻阵容爆发"},
    "马德里竞技": {"fifa_rank": "N/A", "style": "防守反击、铁血纪律", "stars": "格列兹曼、希门尼斯、德保罗", "recent": "西甲前四，西蒙尼体系稳固"},
    "希拉尔": {"fifa_rank": "N/A", "style": "技术+体能、中东豪门", "stars": "内马尔、米林科维奇", "recent": "沙特联领头羊，亚冠常客"},
    "阿尔阿赫利": {"fifa_rank": "N/A", "style": "进攻型、明星云集", "stars": "马赫雷斯、菲尔米诺", "recent": "沙特联争冠集团"},
}
